...
@Component({
  selector: "app-editable-shaded-text",
  standalone: true,
      ...
      <div class="group relative">
        <textarea 
          *ngIf="isEditing; else displayTemplate"
          ...
          class="text-base text-gray-600 italic bg-transparent border-2 border-blue-400 rounded px-2 py-1 w-full focus:outline-none resize-none"
        ...
        <ng-template #displayTemplate>
          <div 
            (click)="startEditing()"
            class="text-base text-gray-600 italic cursor-pointer hover:bg-gray-200 rounded px-2 py-1 transition-colors min-h-[2rem] flex items-center whitespace-pre-wrap"
          >
            {{ content || 'Haz clic para editar el texto sombreado' }}
          </div>
...
export class EditableShadedTextComponent {
  @Input() content = ""
